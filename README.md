# ORACLE-
Oracle is an ESP 32 based truth verification system, that uses multiple sensors to measure stress level and decides whether  not that person is lying. It uses a gsr sweat sensor, detects oxygen saturation of the suspects body, and calculates the probability of that person lying. 


## Why I Made Project ORACLE:
I've always had a fascination for integrating hardware with biometric data and solvoing some kind of problem with it or make something cool!
I got that chance when my school declared the date (which is very soon) for the science fair. So, I am building this project, for the science fair as well as personal interests,


## Screenshot Of The Full 3D Model:
<img width="574" height="447" alt="17778384162201957443152565096807" src="https://github.com/user-attachments/assets/aa618934-48cd-4208-a49a-4cf4dfb5b522" />

## Some Pictures From The Design Phase:
### 1) ESP-32:
<img width="1340" height="800" alt="17778385831411979521632212546355" src="https://github.com/user-attachments/assets/8d5c981f-2eec-44f3-ba0a-bbd0c1f6e63f" />

<br>
<br>


### 2) MAX 30105 (Pulse and Oximeter Sensor):

<img width="1340" height="800" alt="17778386723513654309613116345026" src="https://github.com/user-attachments/assets/e39af6f7-d4e9-4484-a53c-d09e0f2dd4a2" />

<br> <br>


### 3) GSR Sensor:
<img width="1340" height="800" alt="17778388503332183015804533778932" src="https://github.com/user-attachments/assets/38da6e1a-d4d1-4d83-9206-e9e1fb5b3af9" />
